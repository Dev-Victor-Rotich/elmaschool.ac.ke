...
import { Mail, Phone, MapPin, Facebook, Twitter, Instagram, Tiktok } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <a
                href="https://www.facebook.com/share/1AKPmJWuGu/"
                target="_blank"
              ...
              <a
                href="https://www.tiktok.com/@elma_high_school?_r=1&_t=ZM-91Wkji8upiO"
                target="_blank"
                rel="noopener noreferrer"
                className="h-9 w-9 rounded-full bg-primary/10 flex items-center justify-center hover:bg-primary hover:text-white transition-smooth"
              >
