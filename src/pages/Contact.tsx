...
import { Phone, Mail, MapPin, Clock, Facebook, Twitter, Instagram, GraduationCap, Users, BookOpen, FileText, Building2, HeartHandshake } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Whether you're a prospective parent, current guardian, or community member, our dedicated team is ready to assist you with any inquiries about El Makamong Secondary School.
            </p>
          </div>
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {helpReasons.map((reason, index) => {
                ...
                return (
                  <Card key={index} className="group border-0 shadow-soft hover:shadow-hover transition-all duration-300 bg-gradient-to-br from-background to-primary/5 hover:to-primary/10 overflow-hidden relative">
          ...
          <div className="grid md:grid-cols-2 gap-6">
                {contactInfo.map((info, index) => {
                  ...
                  return (
                    <Card key={index} className="group shadow-soft border-0 hover:shadow-hover transition-all duration-300 bg-gradient-to-br from-background to-primary/5 hover:to-primary/10 overflow-hidden relative">
                      <div className="absolute inset-0 bg-gradient-to-br from-primary/0 to-accent/0 group-hover:from-primary/5 group-hover:to-accent/5 transition-all duration-300"></div>
                      ...
                      <CardContent className="relative">
                        {info.details.map((detail, idx) => (
                          <p key={idx} className="text-muted-foreground mb-1 text-base">{detail}</p>
                        ))}
                        {info.action && (
                          <Button 
                            variant="link" 
          ...
          <Card className="shadow-hover border-0 bg-gradient-to-br from-accent/10 to-primary/10 overflow-hidden relative">
            ...
            <CardHeader className="relative">
              <CardTitle className="text-2xl md:text-3xl text-center">Ready to Join El Makamong?</CardTitle>
            </CardHeader>
            <CardContent className="text-center space-y-6 relative">
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Enrollment for 2026 is now open. Contact us today to schedule a school visit or learn more about our admission process.
              </p>
