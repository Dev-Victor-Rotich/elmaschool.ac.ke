...
const Brochures = () => {
  ...
  const brochureCards = [
    ...
    },
    {
      ...
      gradient: "from-primary via-secondary/80 to-accent/70",
      accent: "secondary",
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Enrollment Brochures - Elma School, Kamonong</title>
        <meta name="description" content="Download and share Elma School enrollment brochures. Now enrolling Form 3, Form 4 & Grade 10 for 2026. Join our 98% success rate institution." />
      </Helmet>
                ...
                <div key={card.id} className="space-y-4">
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      {card.id === "success-stories" && card.stats && (
