        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Download your official admission letter based on your class and curriculum. 
                All letters are official documents for Form 3, Form 4 (8-4-4) and Grade 10 (CBC) enrollment.
              </p>
            </div>
            ...
            <div className="mt-8 bg-gradient-to-br from-accent/10 to-primary/10 border border-primary/20 rounded-xl p-6 text-center">
              ...
              <p className="text-muted-foreground">
                All admission letters are official documents issued by Elma Kamonong High School. 
                Please ensure you download the correct letter for your class and curriculum.
              </p>
            </div>
          </section>
          ...
          <Card className="mb-12 bg-gradient-to-br from-primary/5 to-accent/5 border-0 shadow-soft">
            ...
            <CardContent>
              <p className="text-lg leading-relaxed mb-4">
                We are delighted that you are considering Elma Kamonong High School for your child's secondary education. 
                Our admissions process is designed to ensure that each student who joins our community will thrive in our 
                  ...
                  <Card key={index} className="border-0 shadow-soft overflow-hidden">
                    ...
                    <CardContent className="pt-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h3 className="font-bold text-xl mb-2">Step {index + 1}: {step.title}</h3>
            ...
            <Card className="border-0 shadow-soft bg-gradient-to-br from-accent/5 to-primary/5">
              <CardContent className="pt-6">
                <p className="text-lg leading-relaxed mb-4">
                  ...
                  competitive and transparent, covering accommodation, meals, academic instruction, and co-curricular activities.
                </p>
            ...
            <Card className="border-0 shadow-hover">
              <CardContent className="pt-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">admissions@elmakamonong.ac.ke</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center">
                ...
                <div className="mt-6 text-center">
                  <Button className="bg-gradient-to-r from-primary to-accent text-white shadow-soft hover:shadow-hover transition-smooth" asChild>
          ...
          <Card className="bg-gradient-to-br from-primary/5 to-accent/5 border-0 shadow-soft">
            <CardContent className="pt-6 text-center">
              <p className="text-lg leading-relaxed">
                We look forward to welcoming your child to the Elma Kamonong High School family. 
                For any questions about the admissions process, please don't hesitate to contact us.
              </p>
            </CardContent>
          </Card>
        </div>
